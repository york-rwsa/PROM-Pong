...
class Pong(Game):
  def __init__ (self, debug=False):
    ...
    self.batLeft = Bat(3, 12, 6, "red", ControllerHandler(self.bus, constants.LEFT_BAT_I2C_ADDRESS, constants.LEFT_BAT_CMD_CODE))
    self.batRight = Bat(77, 12, -6, "blue", ControllerHandler(self.bus, constants.LEFT_BAT_I2C_ADDRESS, constants.LEFT_BAT_CMD_CODE))
